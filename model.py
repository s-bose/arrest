...
#   filename:  https://petstore3.swagger.io/api/v3/openapi.json
#   timestamp: 2024-01-21T10:45:00+00:00
...
class PetFindByStatusGetParametersQuery(BaseModel):
    status: Optional[Status1] = 'available'
...
class PetFindByTagsGetParametersQuery(BaseModel):
...
class PetPetIdPostParametersQuery(BaseModel):
    name: Optional[str] = None
    status: Optional[str] = None


class PetPetIdUploadImagePostParametersQuery(BaseModel):
...
class UserLoginGetParametersQuery(BaseModel):
